(() => {
  ...
  nav.innerHTML='<div class="hubPrimaryLinks">'+sections.map(([key,label])=>'<a href="#hub-'+key+'" data-hub-link="'+key+'">'+label+'</a>').join('')+'</div><details class="hubOtherSpaces"><summary>Atlas, community & more</summary><div class="hubOtherLinks"><a href="/zouk-map/#map"><strong>Zouk Atlas</strong><span>Your map and lesson notes ↗</span></a><a href="/zoukable/"><strong>Zoukable</strong><span>Rhythm, practice and your hangar ↗</span></a><a href="/comms-deck/"><strong>ECHO</strong><span>Conversations with the crew ↗</span></a><a href="/feedback/"><strong>Give feedback</strong><span>Help improve your experience ↗</span></a><a href="/curriculum-planner/"><strong>Teaching studio</strong><span>Zouk &amp; Lambada curricula and sessions ↗</span></a><a href="/reviews/"><strong>Student stories</strong><span>Read shared experiences ↗</span></a></div></details>';
