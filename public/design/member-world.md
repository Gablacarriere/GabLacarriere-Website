...
All characters follow the shared Monument Valley × Animal Crossing direction in [the v3 character guide](crew-character-style-guide.md): calm geometric forms, soft matte shading, rounded proportions and warm individual personalities. Keep student explorers simpler and preserve their saved customization. Staff remain recognizable: Gab has his docker hat, crown, right-arm and neck tattoos and telescope; Steph has long dark hair, plum clothing, teal scarf and compass. The v3 pair is the reference for future crew characters.
